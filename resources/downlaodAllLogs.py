...
JOBS_API_URL = "https://hdtgbcdl.cde-jhnkv684.pdf-jul.a465-9q4k.cloudera.site/dex/api/v1"
WORKLOAD_USER = "pauldefusco"
WORKLOAD_PASSWORD = "<your-workload-pwd-here>"
...
allJobRuns = myCdeClusterManager.listJobRuns("spark")
#print(allJobRuns)
...
sparkEventLogs = myCdeClusterManager.downloadJobRunLogs(jobRunId, logsType)
